...
namespace mrVSLAM
{
    ...
    public: 
        ...
        Feature(std::shared_ptr<KeyFrame> kf, const cv::KeyPoint &kp, bool on_left_img = true)
        : keyframe(kf), positionOnImg(kp), is_on_left_img(on_left_img) {} 

        Feature(std::shared_ptr<KeyFrame> kf, const cv::KeyPoint &kp,const cv::Mat &feature_desc, bool on_left_img = true)
    ...
    public: 
        ...
        std::vector<std::shared_ptr<Feature>> features_on_left_img; 
        std::vector<std::shared_ptr<Feature>> features_on_right_img; 
    ...
    private:     
        ...
        Sophus::SE3d relativePose; ///< pose of camera/frame relative to
