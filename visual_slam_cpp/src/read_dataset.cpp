...
#include "mrVSLAM/data_parser.hpp"
...
namespace mrVSLAM
{
    ...
    std::vector<Eigen::Matrix<double, 3,4, Eigen::RowMajor>> KITTI_Dataset::retrunGTposes() {
        return this->ground_truth_poses;
    }

    Eigen::Matrix<double, -1,-1, Eigen::RowMajor> KITTI_Dataset::returnP0() {
        return this->P0;
    }

    Eigen::Matrix<double, -1,-1, Eigen::RowMajor> KITTI_Dataset::returnP1() {
        return this->P1;
    }
...
// --------------------------------------------------------------- //
    ...
    Eigen::Matrix<double, -1,-1, Eigen::RowMajor> EuRoC_Dataset::returnP0() {
        return this->P0;
    }

    Eigen::Matrix<double, -1,-1, Eigen::RowMajor> EuRoC_Dataset::returnP1() {
        return this->P1;
    }

    void EuRoC_Dataset::showPmatricies()
    {
        std::cout << "---------------- \n";
        std::cout << "Left grayscale camera projection matrix = \n" << P0 << "\n";
        std::cout << "\n";
